...
urlpatterns = [
    ...
    path('', include('federation.urls')), # ActivityPub: /users/<username>, /.well-known/webfinger
...
# In real production have a real web server like nginx or apache. not really needed for size of project.
if settings.DEBUG:
